...
@section('content')
                    ...
                    @if ($i < 3)
                        <div class="card text-center mb-3 ml-3" style="width: 18rem;">
                            <img class="card-img-top" style="height: 180px;"
                                src="{{ asset('storage/' . $products[$i]->product_image) }}" alt="Card image cap">
                            <div class="card-body">
                                ...
                                </p> <a href="{{ route('product', ['id' => $products[$i]->id]) }}" class="btn card-btn">Buy
                                    Now</a>
                            </div>
                        </div>
                    @endif
    ...
    <section class="container-fluid mt-3" id="section3">
        <div class="row justify-content-center " style="padding: 10% 0 ;">
            @if (isset($products[3]))
                <a href="{{ route('product', ['id' => $products[3]->id]) }} "
                    style="text-decoration: none ;color: #b589f1;">
            ...
            @if (isset($products[4]))
                <a href="{{ route('product', ['id' => $products[4]->id]) }} "
                    ...
                    <div class=" d-flex justify-content-end flex-column CenterFristCol "> <img
            ...
            @endif
            @if (isset($products[5]))
                <a href="{{ route('product', ['id' => $products[5]->id]) }} "
                    style="text-decoration: none ;color: #b589f1;">

                    <div class=" d-flex justify-content-end flex-column ">
                        <img class="img-fluid custom-width mx-auto"
        ...
        <div class="col-4 d-flex justify-content-center flex-column ">
            @if (isset($products[6]))
                <a href="{{ route('product', ['id' => $products[6]->id]) }} "
                    style="text-decoration: none ;color: #b589f1;">
            ...
            @endif
            @if (isset($products[7]))
                <a href="{{ route('product', ['id' => $products[7]->id]) }} "
                    style="text-decoration: none ;color: #b589f1;">
            ...
            @endif
            @if (isset($products[8]))
                <a href="{{ route('product', ['id' => $products[8]->id]) }} "
                    style="text-decoration: none ;color: #b589f1;">
    ...
    <section class="container-fluid mt-3" id="Section-5">
        <div class="row" id="seciotn-5-row">
            ...
            <div class="col p-div d-inline-flex">
                <div class="col">
                    <img src="{{ asset('user/main-img/Group-53.png') }}" alt="Image 1" id="KidsImg"
                        class="img-fluid">
            ...
            <div class="carousel-inner py-4">
                ...
                <div class="carousel-item active carousel-item-start">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card text-center mb-3 ml-3 articleCard" id="CenterdArticleCard"
                                    style="width: 18rem;">

                                    <div class="inline-elements d-flex justify-content-beteween">
                                        <h5>Article</h5>
                                        <img src="{{ asset('user/main-img/Cherry.png') }}" class="card-img-top-Article"
                                            alt="Card image cap">
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text articleP">Some quick example text to build on the Article and
                                            make up the bulk of the card's content Some quick example text to build on the
                                            Article and make up the bulk of the cardSome quick example text to build on the
                                            Article and make up the bulk of the cardSome quick example text to build on the
                                            Article and make up the bulk of the card.</p>
                                    </div>
                                </div>
                            </div>
