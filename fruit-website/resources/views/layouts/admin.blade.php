...
<head>
  <link rel="stylesheet" href="{{ asset('vendor/sweetalert/sweetalert.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('admin/assets/vendor/css/core.css') }}"
        ...
        <link rel="stylesheet" href="{{ asset('admin/assets/vendor/css/custome.css') }}"
        class="template-customizer-core-css" />
        ...
        <div class="layout-container">
          ...
          <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
              ...
              <li class="menu-item {{ Request::is('categories*') ? 'active' : '' }}" style="">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{route('categories.add')}}" class="menu-link">
                      <div data-i18n="Without menu">Add New Categories</div>
                    </a>
                  </li>
                  <li class="menu-item">
