        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <input disabled type="text" class="form-control" required name="Gift_Name" id="basic-icon-default-fullname"
                        placeholder="" value="{{$Gift->name}}" aria-label="JApple"  aria-describedby="basic-icon-default-fullname2">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input disabled id="" class="form-control" value="{{$Gift->price}}" name="Gift_Price" type="text" placeholder="10 $">
          ...
          <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    <img class="img-thumbnail" src="{{asset('storage/'.$Gift->image)}}">
                  </div>
            </div>
          </div>
