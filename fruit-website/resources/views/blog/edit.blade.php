        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <input type="text" value="{{$article->title}}" class="form-control" required name="title" id="basic-icon-default-fullname"
                        placeholder="" value="" aria-label="title" aria-describedby="basic-icon-default-fullname2">
                </div>
            
                    <div>
            <label for="" class="form-label">Short Description </label>
            <textarea class="form-control"  name="short_description" id="short_description" required>{{$article->short_description}}</textarea>
        </div>
        <div>
            <label for="" class="form-label"> content </label>
            <textarea class="form-control"  name="content" id="content" required>{{$article->content}}</textarea>
        </div>  
